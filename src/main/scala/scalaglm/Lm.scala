...
/** Linear regression modelling
  ...
  *
  * @return
  *   An object of type Lm with many useful attributes providing information
  *   about the regression fit
  */
case class Lm(
    y: DVD,
    Xmat: DMD,
  ...
  /** Prints a human-readable regression summary to the console
    */
  def summary: Unit = {
    println("Estimate\t S.E.\t t-stat\tp-value\t\tVariable")
    println("---------------------------------------------------------")
...
object Lm {
  ...
  /** Constructor without a name list
    */
  def apply(y: DVD, Xmat: DMD, addIntercept: Boolean): Lm = {
    val p = Xmat.cols
